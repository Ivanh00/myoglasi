...
class Index extends Component
{
    ...
    {
        // Check if we're showing scheduled auctions
        if ($this->sortBy === 'scheduled') {
            // Scheduled auctions query
            ...
            if ($this->selectedSubcategory) {
                ...
                if ($subcategory) {
                    ...
                    $scheduledQuery->whereHas('listing', function($q) use ($subcategoryIds) {
            ...
            $auctions = $scheduledQuery->orderBy('starts_at', 'asc')->paginate($this->perPage);
        } else {
        ...
        // Don't show scheduled and ended sections when viewing scheduled filter
        if ($this->sortBy === 'scheduled') {
