...
class BusinessManagement extends Component
{
    ...
    public function editBusiness($id)
    {
        ...
        if ($this->selectedBusiness) {
            $this->editState = [
                ...
                'address_1' => $this->selectedBusiness->address_1,
                'address_2' => $this->selectedBusiness->address_2,
    ...
    public function updateBusiness()
    {
        $this->validate([
            ...
            'editState.address_1' => 'nullable|string|max:255',
            'editState.address_2' => 'nullable|string|max:255',
        ...
        $this->selectedBusiness->update([
            ...
            'address_1' => $this->editState['address_1'],
            'address_2' => $this->editState['address_2'],
