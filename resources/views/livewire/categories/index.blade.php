<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    <div class="mb-8">
        ...
        <p class="text-slate-600">Pronađite ono što tražite u našim kategorijama</p>
    </div>
            ...
            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                <div class="p-6">
                    ...
                    @if($category->description)
                        <p class="text-slate-600 text-sm mb-4">{{ Str::limit($category->description, 100) }}</p>
                    @endif
    ...
    @if($categories->isEmpty())
        <div class="text-center py-12">
            ...
            <p class="text-slate-600">Kategorije će biti dodane uskoro.</p>
        </div>
    @endif
</div>
