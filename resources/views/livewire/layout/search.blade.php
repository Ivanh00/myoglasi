    ...
    <form action="{{ route('search.index') }}" method="GET">
        <div class="flex shadow-sm rounded-md">
            ...
            <button type="button" @click="open = true; restoreValues()"
                ...
                :class="hasActiveFilters() ? 'bg-sky-100 text-sky-700 border-sky-300' : 'bg-slate-50 text-slate-700 hover:bg-slate-100'">
                <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    :class="hasActiveFilters() ? 'text-sky-600' : 'text-slate-500'">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full"
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div x-show="cityOpen" x-transition @click.away="cityOpen = false"
                                    ...
                                    <div class="p-2 max-h-48 overflow-y-auto">
                                        <template x-for="cityOption in filteredCities" :key="cityOption">
                                            <button type="button"
                                                @click="selectedCity = cityOption; cityOpen = false"
                                        ...
                                        <div x-show="filteredCities.length === 0"
                                            class="text-center text-slate-500 py-2">
                                            Nema rezultata
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Kategorija -->
                            <div>
                                <label for="category" class="block text-sm font-medium text-slate-700 mb-1">Kategorija</label>
                            ...
                            <!-- Stanje -->
                            <div>
                                <label for="condition" class="block text-sm font-medium text-slate-700 mb-1">Stanje</label>
                            ...
                            <!-- Cena od -->
                            <div>
                                <label for="price_min" class="block text-sm font-medium text-slate-700 mb-1">Cena od (RSD)</label>
                            ...
                            <!-- Cena do -->
                            <div>
                                <label for="price_max" class="block text-sm font-medium text-slate-700 mb-1">Cena do (RSD)</label>
