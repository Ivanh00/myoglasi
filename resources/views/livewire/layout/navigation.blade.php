                ...
                <form action="{{ route('search.index') }}" method="GET">
                    <div class="relative">
                        ...
                        <input type="text" name="query"
                            class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md bg-white placeholder-gray-400 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-gray-400 focus:border-gray-400 sm:text-sm"
