                            ...
                            <div x-show="open" @click.away="open = false" x-transition
                                ...
                                <div class="py-1">
                                    ...
                                    <a href="{{ route('services.create') }}" @click="open = false"
                                        ...
                                        <i class="fas fa-tools text-slate-600 mr-3"></i>
                                        Usluga
                                    </a>
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    ...
                                    <svg class="ml-1 h-4 w-4 text-slate-700 dark:text-slate-200" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <x-slot name="content">
                                ...
                                @else
                                    ...
                                    <x-dropdown-link href="{{ route('listings.my') }}" class="!bg-sky-600 !text-white hover:!bg-sky-700 dark:hover:!bg-slate-800">
                                        <i class="fas fa-list mr-2"></i>
                                        Moji oglasi
                                    </x-dropdown-link>
                                    <x-dropdown-link href="{{ route('auctions.my') }}" class="!bg-amber-600 !text-white hover:!bg-amber-700 dark:hover:!bg-slate-800">
                                        <i class="fas fa-gavel mr-2"></i>
                                        Moje aukcije
                                    </x-dropdown-link>
                                    <x-dropdown-link href="{{ route('services.my') }}" class="!bg-slate-600 !text-white hover:!bg-slate-700 dark:hover:!bg-slate-800">
            ...
            <div class="md:hidden flex items-center space-x-3 relative z-50">
                @auth
                    ...
                    <a href="{{ route('listings.create') }}"
                        ...
                        <svg class="h-5 w-5 text-slate-700 dark:text-slate-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
