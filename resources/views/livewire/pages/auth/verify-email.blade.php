...
<div>
    <div class="text-center mb-6">
        <div class="w-20 h-20 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <i class="fas fa-envelope text-sky-600 dark:text-sky-400 text-3xl"></i>
        </div>
    ...
    <div class="mb-6 text-sm text-slate-600 dark:text-slate-400 text-center">
        <p class="mb-3">Hvala što ste se registrovali! Pre nego što počnete da koristite PazAriO, molimo vas da
            verifikujete vašu email adresu klikom na link koji smo vam poslali.</p>
