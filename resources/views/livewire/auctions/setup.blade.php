    ...
    <div class="max-w-4xl mx-auto px-4">
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-gray-900 mb-2">Postavite aukciju</h1>
                <p class="text-gray-600">Konfigurirajte parametere aukcijske prodaje</p>
            </div>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-8">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-yellow-900">{{ $listing->title }}</h3>
                        <p class="text-yellow-800 text-sm">Trenutna cena: {{ number_format($listing->price, 0, ',', '.') }} RSD</p>
                        <p class="text-yellow-700 text-sm">{{ $listing->category->name }} • {{ $listing->location }}</p>
                    </div>
                </div>
            </div>
            ...
            <form wire:submit.prevent="createAuction">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Left Column: Pricing -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Cene</h3>
                        
                        <!-- Starting Price -->
                        <div class="mb-6">
                            <label for="startingPrice" class="block text-sm font-medium text-gray-700 mb-2">
                                Početna cena aukcije <span class="text-red-500">*</span>
                            </label>
                            <input type="number" wire:model="startingPrice" id="startingPrice" step="1" min="1"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500">
                            <p class="text-xs text-gray-500 mt-1">Preporučeno: 70% od trenutne cene ({{ number_format($listing->price * 0.7, 0, ',', '.') }} RSD)</p>
                            @error('startingPrice') 
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" wire:model="buyNowPrice" id="buyNowPrice" step="1" min="1"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500">
                            <p class="text-xs text-gray-500 mt-1">Kupci mogu kupiti odmah po ovoj ceni</p>
                            @error('buyNowPrice') 
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <!-- Right Column: Timing -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Vremenski okvir</h3>
                        ...
                        @if($startType === 'scheduled')
                            <div class="mb-6">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label for="startDate" class="block text-sm font-medium text-gray-700 mb-2">Datum</label>
                                    ...
                                    <div>
                                        <label for="startTime" class="block text-sm font-medium text-gray-700 mb-2">Vreme</label>
                        ...
                        <!-- Duration -->
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 mb-3">Trajanje aukcije</label>
                ...
                <div class="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
                    <h4 class="text-blue-900 font-semibold mb-3">Pravila aukcije</h4>
                    <ul class="text-blue-800 text-sm space-y-2">
                        <li class="flex items-start">
                            <i class="fas fa-info-circle mr-2 mt-0.5"></i>
                            <span>Aukcija se automatski produžava za 3 minuta ako stigne ponuda u poslednje 3 minuta</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-info-circle mr-2 mt-0.5"></i>
