            ...
            <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-amber-800 text-sm">Trenutna cena: {{ number_format($listing->price, 0, ',', '.') }} RSD</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-xs text-slate-500 mt-1">Preporučeno: 70% od trenutne cene ({{ number_format($listing->price * 0.7, 0, ',', '.') }} RSD)</p>
                            @error('startingPrice') 
                        ...
                        @if($startType === 'scheduled')
                            <div class="mb-6">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label for="startDate" class="block text-sm font-medium text-slate-700 mb-2">Datum</label>
                                    ...
                                    <div>
                                        <label for="startTime" class="block text-sm font-medium text-slate-700 mb-2">Vreme</label>
                            ...
                            <div class="grid grid-cols-5 gap-2">
                                @foreach($durationOptions as $days => $label)
                                    <label class="flex flex-col items-center cursor-pointer p-3 border-2 rounded-lg transition-all
                                        ...
                                        <span class="text-sm font-medium {{ $duration == $days ? 'text-amber-700' : 'text-slate-700' }}">
                                            {{ $label }}
                                        </span>
                                    </label>
                                @endforeach
