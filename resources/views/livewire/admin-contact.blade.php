    ...
    <section class="navigation-holder">
        <a class="back-button" href="{{ route('home') }}">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 15L3.63057 8.32978C3.54697 8.24236 3.5 8.12372 3.5 8C3.5 7.87628 3.54697 7.75764 3.63057 7.67022L10 1"
        ...
        <div class="user-info-holder">
            <div class="user-name-holder" style="display: flex; align-items: center; gap: 0.5rem;">
                <span class="user-avatar">
                    ...
                    @else
                        <div style="width: 40px; height: 40px; background-color: #dc2626; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600;">
                ...
                <div class="message-item {{ $message->sender_id == auth()->id() ? 'my-message' : 'other-message' }}">
                    <div class="message-bubble">
                        @if($message->subject && $loop->first)
                            <div style="font-weight: bold; margin-bottom: 0.5rem; padding-bottom: 0.5rem; border-bottom: 1px solid rgba(255,255,255,0.2);">
                                {{ $message->subject }}
                            </div>
                        @endif
