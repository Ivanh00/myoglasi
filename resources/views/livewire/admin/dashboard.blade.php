        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                <div class="bg-white border border-slate-200 rounded-lg p-4">
                    <h3 class="text-sm font-medium text-slate-500 dark:text-slate-300">Danas registracija</h3>
                    <p class="text-2xl font-bold text-slate-900">{{ $stats['today_registrations'] }}</p>
                </div>
                <div class="bg-white border border-slate-200 rounded-lg p-4">
                    <h3 class="text-sm font-medium text-slate-500 dark:text-slate-300">Danas oglasa</h3>
                    <p class="text-2xl font-bold text-slate-900">{{ $stats['today_listings'] }}</p>
                </div>
                <div class="bg-white border border-slate-200 rounded-lg p-4">
                    <h3 class="text-sm font-medium text-slate-500 dark:text-slate-300">Prosečno stanje</h3>
                    <p class="text-2xl font-bold text-slate-900">{{ number_format($stats['avg_user_balance'], 0) }} RSD
                    </p>
                </div>
                <div class="bg-white border border-slate-200 rounded-lg p-4">
                    <h3 class="text-sm font-medium text-slate-500 dark:text-slate-300">Korisnici sa kreditima</h3>
                    ...
                    <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs text-slate-400">Balans: {{ number_format($user->balance ?? 0, 0) }}
                                    RSD</p>
                            </div>
                        </div>
                ...
                @foreach ($recentListings as $listing)
                    <div class="p-3 bg-slate-50 rounded-lg">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-sm font-medium text-slate-900">{{ Str::limit($listing->title, 20) }}
                                </p>
                                <p class="text-sm text-slate-500 dark:text-slate-300">
                                    {{ $listing->category->name ?? 'Bez kategorije' }}</p>
                        ...
                        <div class="mt-2 flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-green-600">{{ number_format($listing->price, 0) }}
                                RSD</span>
                        </div>
                    </div>
                @endforeach
