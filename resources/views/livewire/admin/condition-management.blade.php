<div>
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Upravljanje stanjima oglasa</h1>
                <p class="text-gray-600">Pregled i upravljanje stanjima oglasa (npr. Novo, Polovno, Oštećeno)</p>
            </div>
            <button wire:click="createCondition" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
                + Novo stanje
            </button>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Broj
                            oglasa</th>
                    ...
                    @forelse($conditions as $condition)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $condition->name }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $condition->slug }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                    ...
                    <form wire:submit.prevent="saveCondition">
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <label class="ml-2 text-sm text-gray-600">Aktivno stanje</label>
                            </div>
                        </div>
