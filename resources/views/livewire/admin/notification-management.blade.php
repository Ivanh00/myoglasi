    ...
    @unless ($embedded)
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg border border-blue-200">
                <h3 class="text-sm font-medium text-blue-800 dark:text-blue-200">Ukupno korisnika</h3>
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Naslov</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Prima
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Poruka</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @if ($notification->listing)
                                        <div class="text-xs text-gray-500 mt-1">Vezano za:
        ...
        <div class="lg:hidden space-y-4">
            @forelse($sentNotifications as $notification)
                <div class="bg-white shadow rounded-lg p-4">
                    ...
                    <div class="bg-gray-50 p-3 rounded-lg mb-4">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <div class="flex items-center">
                                ...
                                @else
                                    <div
                                        class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-xs mr-2">
                                        {{ strtoupper(substr($notification->receiver->name, 0, 1)) }}
                                    </div>
                                @endif
                            </div>
                    ...
                    @if ($notification->listing)
                        <div class="mb-4">
                            <div class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Vezano za oglas
                            </div>
                    ...
                    <form wire:submit="sendNotification">
                        <div class="space-y-6">
                            ...
                            @if ($notificationData['recipient_type'] === 'single')
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Pretraži
                                        korisnika</label>
                            ...
                            @if ($notificationData['recipient_type'] === 'filtered')
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Filter
                                        korisnika</label>
                                    ...
                                    @if ($notificationData['filter_criteria']['user_type'] === 'recent')
                                        <div class="mt-2">
                                            <label class="block text-xs text-gray-600">Registrovani u poslednih X
                                                dana</label>
                                            <input type="number"
                            ...
                            <div>
                                ...
                                <textarea wire:model="notificationData.message" rows="4"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="Unesite poruku obaveštenja..."></textarea>
                            ...
                            @if ($notificationData['recipient_type'] === 'single')
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Vezano za oglas
                                        (opciono)</label>
                                    ...
                                    @if ($notificationData['recipient_id'])
                                        <div class="text-xs text-gray-500 mt-1">Prikazuju se oglasi odabranog korisnika
                                        </div>
                                    @else
                                        <div class="text-xs text-gray-500 mt-1">Prvo odaberite korisnika da vidite
                                            njegove oglase</div>
                                    @endif
                                </div>
                            @endif
