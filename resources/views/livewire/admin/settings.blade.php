                    ...
                    <div class="border border-slate-200 rounded-lg p-4">
                        ...
                        <div class="space-y-4">
                            ...
                            @if($monthlyPlanEnabled)
                                <div>
                                    <label class="block text-sm font-medium text-slate-700">Cena mesečnog plana (RSD)</label>
                                    ...
                                    <p class="text-xs text-slate-500 mt-1">Korisnici mogu postavljati neograničeno oglasa mesečno</p>
                    ...
                    <div class="border border-slate-200 rounded-lg p-4">
                        ...
                        <div class="space-y-4">
                            ...
                            @if($yearlyPlanEnabled)
                                <div>
                                    <label class="block text-sm font-medium text-slate-700">Cena godišnjeg plana (RSD)</label>
                                    ...
                                    <p class="text-xs text-slate-500 mt-1">Korisnici mogu postavljati neograničeno oglasa godišnje</p>
        ...
        @if($activeTab === 'general')
            <div class="space-y-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700">Maksimalno aktivnih oglasa (besplatni korisnici)</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700">Minimalni iznos za deljenje kredita (RSD)</label>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-700 p-4 rounded-lg border border-slate-200 dark:border-slate-600">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <div class="flex items-center mb-2">
                                    ...
                                    <label for="listing_fee_enabled" class="ml-2 text-sm font-medium text-slate-700 dark:text-slate-300">
                                        Naplaćivanje oglasa
                                    </label>
                                </div>
                                @if($listingFeeEnabled)
                                    <input type="number" wire:model="listingFeeAmount" min="1" max="1000"
                                    ...
                                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                        Cena za postavljanje oglasa: {{ number_format($listingFeeAmount, 0, ',', '.') }} RSD
                                    </p>
                                @else
                                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                        Oglasi su besplatni
                            ...
                            <div>
                                <div class="flex items-center mb-2">
                                    <input type="checkbox" id="service_fee_enabled" wire:model="serviceFeeEnabled"
                                        class="h-4 w-4 text-sky-600 focus:ring-sky-500 border-slate-300 dark:border-slate-600 rounded">
                                    <label for="service_fee_enabled" class="ml-2 text-sm font-medium text-slate-700 dark:text-slate-300">
                                        Naplaćivanje usluga
                                    </label>
                                </div>
                                @if($serviceFeeEnabled)
                                    <input type="number" wire:model="serviceFeeAmount" min="1" max="1000"
                                        class="mt-1 block w-full px-3 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 rounded-md focus:ring-sky-500 focus:border-sky-500">
                                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                        Cena za postavljanje usluge: {{ number_format($serviceFeeAmount, 0, ',', '.') }} RSD
                                    </p>
                                @else
                                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                        Usluge su besplatne
                        ...
                        <div class="mt-4 p-3 bg-sky-50 dark:bg-sky-900 border border-sky-200 dark:border-sky-700 rounded-lg">
                            <div class="text-sm text-sky-800 dark:text-sky-200">
                                ...
                                <strong>Napomena:</strong> Ove cene se naplaćuju korisnicima koji imaju omogućeno plaćanje "po oglasu/usluzi".
                    ...
                    <div class="space-y-4">
                        ...
                        @if($serviceFeeEnabled)
                            <div class="mt-4">
                                <label class="block text-sm font-medium text-slate-700">Cena za objavljivanje usluge (RSD)</label>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    @if($gameCreditEnabled)
                                        <div class="ml-6">
                                            <label class="block text-sm font-medium text-slate-700">Maksimalno kredita dnevno kroz igrice (RSD)</label>
                                ...
                                <div>
                                    ...
                                    @if($dailyContestEnabled)
                                        <div class="ml-6">
                                            <label class="block text-sm font-medium text-slate-700">Nagrada za pobednika dnevnog konkursa (RSD)</label>
                                ...
                                <div>
                                    ...
                                    @if($gameLeaderboardEnabled)
                                        <div class="ml-6">
                                            <label class="block text-sm font-medium text-slate-700">Bonus za dnevnog pobednika po igri (RSD)</label>
            ...
            <div class="space-y-6">
                ...
                <div class="mt-6 p-4 bg-slate-50 border border-slate-200 rounded-lg">
                    ...
                    <div class="text-xs text-slate-600 mt-3 p-2 bg-slate-100 border border-slate-300 rounded">
                        💡 <strong>Napomena:</strong> Za Google i Facebook login potrebna je OAuth konfiguracija. Vidi OAUTH_SETUP.md za instrukcije.
                    </div>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="border border-slate-200 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div class="lg:col-span-2">
                            <label class="block text-sm font-medium text-slate-700">Template poziva na broj (odobrenja)</label>
                            <input type="text" wire:model="referenceNumberTemplate"
                                class="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md focus:ring-purple-500 focus:border-purple-500">
                            <p class="text-xs text-slate-500 mt-1">Koristite {user_id} za ID korisnika, npr: 20-10-{user_id}</p>
        ...
        @if($activeTab === 'auctions')
            <div class="space-y-6">
                ...
                <div class="border border-slate-200 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-slate-700">Minimalni korak povećanja ponude (RSD)</label>
                ...
                <div class="border border-slate-200 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700">Aktivacija produžavanja (minuti)</label>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="border border-slate-200 rounded-lg p-6">
                        ...
                        <p class="text-sm text-slate-600 mb-4">Udvostručuje dozvoljen broj slika za oglas (trenutno: max {{ \App\Models\Setting::get('max_images_per_listing', 10) }} → {{ \App\Models\Setting::get('max_images_per_listing', 10) * 2 }} slika)</p>
                    ...
                    <div class="border border-slate-200 rounded-lg p-6">
                        ...
                        <p class="text-sm text-slate-600 mb-4">Produžava vreme isteka oglasa</p>
        ...
        @if($activeTab === 'data')
            <div class="space-y-6">
                ...
                <div class="border border-slate-200 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <p class="text-sm text-slate-600">Tip baze:</p>
                            <p class="font-medium">{{ $databaseType }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-slate-600">Veličina baze:</p>
                            <p class="font-medium">{{ $databaseSize }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-slate-600">Broj tabela:</p>
                            <p class="font-medium">{{ $tableCount }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-slate-600">Poslednji backup:</p>
