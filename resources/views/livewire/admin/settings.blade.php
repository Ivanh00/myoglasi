                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <div class="flex items-center mb-2">
                                    ...
                                    <label for="listing_fee_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                        Naplaćivanje oglasa
                                    </label>
                                </div>
                                @if($listingFeeEnabled)
                                    <input type="number" wire:model="listingFeeAmount" min="1" max="1000"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div>
                                <div class="flex items-center mb-2">
                                    <input type="checkbox" id="service_fee_enabled" wire:model="serviceFeeEnabled"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 rounded">
                                    <label for="service_fee_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                        Naplaćivanje usluga
                                    </label>
                                </div>
        ...
        @if($activeTab === 'email')
            <div class="space-y-6">
                ...
                <div class="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-white border border-gray-200 rounded">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="font-medium text-gray-900">Magic Link Login</div>
                                    <div class="text-sm text-gray-600">Prijava preko email link-a</div>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-white border border-gray-200 rounded">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="font-medium text-gray-900">Google Login</div>
                                    <div class="text-sm text-gray-600">Prijava preko Google naloga</div>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-white border border-gray-200 rounded">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="font-medium text-gray-900">Facebook Login</div>
                                    <div class="text-sm text-gray-600">Prijava preko Facebook naloga</div>
                                </div>
                            </div>
                    ...
                    <div class="text-xs text-gray-600 mt-3 p-2 bg-gray-100 border border-gray-300 rounded">
