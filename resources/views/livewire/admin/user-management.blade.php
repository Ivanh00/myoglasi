                            ...
                            <td colspan="7" class="px-4 py-2 bg-slate-50">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <button wire:click="adjustBalance({{ $user->id }})"
                                        ...
                                        <i class="fas fa-wallet mr-1"></i> Balans
                                    </button>

                                    <button wire:click="editUserPayment({{ $user->id }})"
                                        class="inline-flex items-center px-2 py-1 text-sky-600 hover:text-sky-800 rounded">
                                        <i class="fas fa-credit-card mr-1"></i> Plaćanje
                                    </button>

                                    <button wire:click="openVerificationModal({{ $user->id }})"
                                        class="inline-flex items-center px-2 py-1 text-green-600 hover:text-green-800 rounded">
                                        <i class="fas fa-user-check mr-1"></i> Verifikacija
                                    </button>
