<div class="max-w-4xl mx-auto py-6 px-4">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="mb-6 border-b border-gray-200 dark:border-gray-600 pb-4">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Izmeni oglas</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-2">Ažurirajte podatke vašeg oglasa</p>
        </div>
        ...
        <form wire:submit.prevent="update" class="space-y-6">
            ...
            @if($hasAuction)
                <div class="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-lg border border-yellow-200 dark:border-yellow-700 mb-6">
            ...
            <div>
                ...
                @else
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Nema dodatin slika.</p>
                @endif
            </div>
            ...
            @else
                <div class="border-2 border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center bg-gray-50 dark:bg-gray-700">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 font-medium">Dostigli ste maksimum od {{ \App\Models\Setting::get('max_images_per_listing', 10) }} slika</p>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Obrišite neku postojeću sliku da biste dodali novu</p>
                </div>
            @endif
