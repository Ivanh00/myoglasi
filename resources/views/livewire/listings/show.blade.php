                        ...
                        <x-image-lightbox :images="$imageArray" :title="$listing->title">
                            <div class="relative">
                                ...
                                <div class="grid grid-cols-4 gap-2">
                                    ...
                                    @if ($index === 0) @if ($listing->isGiveaway())
                                            border-green-500
                                        @else
                                            border-sky-500 @endif
@else
border-slate-200
                                    @endif">
                                            <img src="{{ $image->url }}"
                    ...
                    <div class="mb-2">
                        <div class="flex items-center p-2">
                            ...
                            @if ($listing->isService())
                                <span
                                    class="ml-4 px-3 py-1 bg-slate-100 text-slate-800 text-sm font-medium rounded-full">
                                    USLUGA
                                </span>
                            @endif
                        </div>
...
<script>
    ...
    function shareListing() {
        ...
        const title = {{ Js::from($listing->title) }};
    ...
    function showSharePopup(url, title, text) {
        ...
        heading.textContent = 'Podeli oglas';
