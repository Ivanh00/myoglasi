    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                <!-- Basic Information -->
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Osnovne informacije</h3>
                ...
                <!-- Contact Information -->
                <div class="mt-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Kontakt informacije</h3>
