<div class="max-w-4xl mx-auto py-6 px-4">
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            {{-- <!-- Dodajte ispod polja za lokaciju i telefon -->
            <div class="p-3 bg-blue-50 border border-blue-200 rounded-lg text-blue-700 text-sm">
                <p class="font-medium">Podaci iz profila</p>
                <p>Lokacija: <strong>{{ auth()->user()->city ?? 'Nije postavljeno' }}</strong></p>
                <p>Telefon: <strong>{{ auth()->user()->phone ?? 'Nije postavljeno' }}</strong></p>
                <p class="mt-2">
                    <a href="{{ route('profile') }}" class="text-blue-600 hover:text-blue-500 underline">
                        Ažuriraj podatke u profilu
                    </a>
                </p>
            </div> --}}
