        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="bg-slate-50 dark:bg-slate-700 p-4 rounded-lg border border-slate-200 dark:border-slate-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <label class="flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all {{ $listingType === 'listing' ? 'border-sky-500 bg-sky-50 dark:bg-sky-900' : 'border-slate-300 dark:border-slate-600 hover:border-slate-400 dark:hover:border-slate-500' }}">
                        <input type="radio" wire:model.live="listingType" value="listing" class="h-4 w-4 text-sky-600 focus:ring-sky-500 border-slate-300">
                        <div class="ml-3">
                            <div class="flex items-center">
                                <i class="fas fa-shopping-tag text-sky-600 mr-2"></i>
                                <span class="text-sm font-medium text-slate-900 dark:text-slate-100">Oglas</span>
                            </div>
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Prodaja proizvoda ({{ \App\Models\Setting::get('listing_fee_enabled') ? \App\Models\Setting::get('listing_fee_amount', 10) . ' RSD' : 'Besplatno' }})</p>
                        </div>
                    </label>

                    <label class="flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all {{ $listingType === 'auction' ? 'border-amber-500 bg-amber-50 dark:bg-amber-900' : 'border-slate-300 dark:border-slate-600 hover:border-slate-400 dark:hover:border-slate-500' }}">
                        <input type="radio" wire:model.live="listingType" value="auction" class="h-4 w-4 text-amber-600 focus:ring-amber-500 border-slate-300">
                        <div class="ml-3">
                            <div class="flex items-center">
                                <i class="fas fa-gavel text-amber-600 mr-2"></i>
                                <span class="text-sm font-medium text-slate-900 dark:text-slate-100">Aukcija</span>
                            </div>
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Licitiranje ({{ \App\Models\Setting::get('listing_fee_enabled') ? \App\Models\Setting::get('listing_fee_amount', 10) . ' RSD' : 'Besplatno' }})</p>
                        </div>
                    </label>

                    <label class="flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all {{ $listingType === 'giveaway' ? 'border-green-500 bg-green-50 dark:bg-green-900' : 'border-slate-300 dark:border-slate-600 hover:border-slate-400 dark:hover:border-slate-500' }}">
                        <input type="radio" wire:model.live="listingType" value="giveaway" class="h-4 w-4 text-green-600 focus:ring-green-500 border-slate-300">
                        <div class="ml-3">
                            <div class="flex items-center">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-sm">
                            ...
                            <p class="text-sky-700 dark:text-sky-300 mt-1">
                                ...
                                <a href="{{ route('services.create') }}" class="underline hover:text-sky-900 dark:hover:text-sky-100">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6">
                ...
                @if($listingType === 'auction')
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center">
                                    <input type="radio" wire:model.live="startType" value="immediately" class="h-4 w-4 text-amber-600 focus:ring-amber-500 border-slate-300">
                                    <span class="ml-2 text-sm text-slate-700 dark:text-slate-300">Odmah posle objave</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" wire:model.live="startType" value="scheduled" class="h-4 w-4 text-amber-600 focus:ring-amber-500 border-slate-300">
                    ...
                    @if($startType === 'scheduled')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                <label for="startTime" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                ...
                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                    ...
                    @if(!empty($images))
                        <span class="text-sky-600">({{ count($images) }}/{{ \App\Models\Setting::get('max_images_per_listing', 10) }})</span>
                    @endif
                </label>
