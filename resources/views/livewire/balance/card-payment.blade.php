    ...
    <div class="max-w-2xl mx-auto px-4">
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Plaćanje karticom</h1>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <span class="text-blue-700 text-sm">Iznos za dopunu:</span>
                        <p class="text-blue-900 text-xl font-bold">{{ number_format($transaction->amount, 0, ',', '.') }} RSD</p>
                    </div>
                    <div>
                        <span class="text-blue-700 text-sm">ID transakcije:</span>
                        <p class="text-blue-900 font-mono text-sm">{{ $transaction->id }}</p>
                    </div>
                </div>
            </div>
            ...
            <form wire:submit.prevent="processPayment">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" 
                                wire:model="paymentData.card_number" 
                                wire:keyup="formatCardNumber"
                                id="card_number"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                wire:model="paymentData.cvv" 
                                id="cvv"
                                placeholder="123"
                                maxlength="4"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-center">
                    ...
                    <div>
                        ...
                        <input type="text" 
                            wire:model="paymentData.cardholder_name" 
                            id="cardholder_name"
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-green-700 text-xs">SSL enkripcija • PCI DSS sertifikovano • Intesa Banka zaštićeno</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <button type="submit" 
                            ...
                            class="flex-1 px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors">
                            ...
                            <div wire:loading.remove wire:target="processPayment" class="flex items-center justify-center">
            ...
            <!-- Processing Overlay -->
            <div wire:loading wire:target="processPayment" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div class="bg-white rounded-lg p-8 max-w-md mx-4">
                    <div class="text-center">
                        <div class="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"></div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">Obrađujem plaćanje</h3>
                        <p class="text-gray-600">Molimo sačekajte, povezujemo se sa Intesa bankom...</p>
                    </div>
                </div>
            </div>
        </div>
