        ...
        <div class="hidden md:block">
            <div class="flex justify-center items-center gap-6">
                ...
                <button wire:click="setFilter('all')"
                    ...
                    <span class="text-sm text-slate-500 dark:text-slate-30">({{ $user->total_ratings_count }})</span>
                </button>
                ...
                <button wire:click="setFilter('neutral')"
                    ...
                    <span class="text-sm text-slate-500 dark:text-slate-300">({{ $user->neutral_ratings_count }})</span>
                </button>
