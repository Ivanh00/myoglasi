    ...
    @auth
        <div class="border-t mt-4 pt-4 p-2">
            ...
            <a href="{{ route('ratings.my') }}"
                class="flex items-center justify-between px-3 py-2 text-blue-700 rounded-lg hover:bg-blue-50 mt-2">
                ...
                @auth
                    ...
                    @endphp
                    @if ($totalRatings > 0)
                        <span class="bg-green-500 text-white rounded px-2 py-1 text-xs font-medium">
                            {{ $totalRatings }}
                        </span>
                    @endif
                @endauth
