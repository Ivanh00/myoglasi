...
<head>
    ...
    <title>Rezultati pretrage - MyOglasi</title>
...
<body class="bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Rezultati pretrage</h1>
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-between items-center">
                                <span
                                    class="text-xl font-bold text-blue-600">{{ number_format($listing->price, 0, ',', '.') }}
                                    RSD</span>
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                <a href="{{ route('listings.show', $listing) }}"
                                    class="text-blue-600 hover:text-blue-800 text-sm font-medium">Pogledaj oglas</a>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        @else
            <div class="bg-white p-8 rounded-lg shadow text-center">
                ...
                <h3 class="mt-2 text-lg font-medium text-gray-900">Nema rezultata</h3>
                <p class="mt-1 text-gray-500">Nijedan oglas ne odgovara vašim filterima.</p>
                <div class="mt-6">
                    <a href="{{ route('search.index') }}"
