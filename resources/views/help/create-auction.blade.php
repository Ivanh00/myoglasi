    ...
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 py-8 px-2 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg overflow-hidden">
                <!-- Header -->
                <div class="bg-gradient-to-r from-amber-500 to-amber-600 p-2 sm:p-8">
                ...
                <div class="p-2 sm:p-8">
                    ...
                    <div
                        ...
                        <p class="text-slate-600 dark:text-slate-400 mb-4">
                            Aukcija je način prodaje gde kupci licitiraju za vaš proizvod, a proizvod dobija onaj ko
                            ponudi najvišu cenu do kraja aukcije.
                        </p>
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div class="text-center">
                                ...
                                <p class="text-sm text-slate-600 dark:text-slate-400">Aukcije traju određeni broj dana
                                </p>
                            </div>
                            <div class="text-center">
                    ...
                    <div class="mb-8 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div
                                ...
                                <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-2">
                                    <i class="fas fa-plus-circle text-sky-600 dark:text-sky-400 mr-2"></i>Direktno
                                    kreiranje
                                </h4>
                            ...
                            <div
                                ...
                                <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-2">
                                    <i
                                        class="fas fa-exchange-alt text-amber-600 dark:text-amber-400 mr-2"></i>Pretvaranje
                                    oglasa
                                </h4>
                                <p class="text-sm text-slate-600 dark:text-slate-400 mb-2">
                                ...
                                <div class="bg-white dark:bg-slate-800 rounded p-2 inline-block">
                                    <span class="text-xs text-slate-600 dark:text-slate-400">Moj oglas → Pretvori u
                                        aukciju</span>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <p class="text-sm text-green-800 dark:text-green-300">
                                ...
                                <strong>Napomena:</strong> Ako na aukciji nema ponuda, možete je vratiti nazad u običan
                                oglas!
                            </p>
                        </div>
                    </div>
                    ...
                    <!-- Steps -->
                    <h2 class="text-xl font-bold text-slate-900 dark:text-slate-100 mb-6">Koraci za postavljanje aukcije
                    </h2>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            <div
                                class="flex-shrink-0 w-10 h-10 bg-amber-100 dark:bg-amber-900/30 rounded-full flex items-center justify-center mr-4">
                                <span class="text-amber-600 dark:text-amber-400 font-bold">1</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Odaberite
                                    način kreiranja</h3>
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-slate-600 dark:text-slate-400">Direktno: Brže za nove
                                            proizvode</span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-check text-green-500 mr-2"></i>
                                        <span class="text-slate-600 dark:text-slate-400">Pretvaranje: Fleksibilno za
                                            postojeće oglase</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Popunite
                                ...
                                <div class="space-y-4">
                                    <div class="border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-slate-600 dark:text-slate-400">
                                            Minimalna cena od koje počinje licitiranje. Preporučujemo da bude 30-50% od
                                            očekivane finalne cene.
                                        </p>
                                    </div>
                                    <div class="border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                                        <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-2">
                                        ...
                                        <p class="text-sm text-slate-600 dark:text-slate-400">
                                            Minimalni iznos za koji se ponuda mora povećati. Obično 5-10% od početne
                                            cene.
                                        </p>
                                    </div>
                                    <div class="border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                                    ...
                                    <div class="border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                                        <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-2">
                                            <i class="fas fa-shield-alt text-amber-500 mr-2"></i>Rezervna cena
                                            (opciono)
                                        </h4>
                                        <p class="text-sm text-slate-600 dark:text-slate-400">
                                            Tajna minimalna cena ispod koje nećete prodati proizvod. Kupci ne vide ovaj
                                            iznos.
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Pokrenite i
                                    upravljajte aukcijom</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                    ...
                    <!-- Tips Section -->
                    <div
                        class="mt-12 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-1">Postavite
                                        atraktivnu početnu cenu</h4>
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Niža početna cena privlači
                                        više učesnika</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-3 mt-1"></i>
                                <div>
                                    <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-1">Kvalitetne
                                        fotografije</h4>
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Dodajte što više fotografija
                                        proizvoda</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Opišite stanje i
                                        karakteristike proizvoda</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-3 mt-1"></i>
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Završite aukciju vikendom ili
                                        uveče</p>
                                </div>
                            </div>
                        </div>
