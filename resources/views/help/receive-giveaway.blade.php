                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div class="mb-8 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-6">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 mb-4">
                            Sistem poklona omogućava korisnicima da besplatno dobiju stvari koje drugi žele da poklone. Sve što trebate je da pronađete poklon koji vas interesuje i pošaljete zahtev vlasniku.
                        </p>
                    ...
                    <div class="mb-8 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-6">
                        ...
                        <ul class="text-slate-600 dark:text-slate-400 space-y-2">
                            <li class="flex items-start">
                                ...
                                <span>Do <strong>{{ \App\Models\Setting::get('max_giveaway_requests', 9) }} korisnika</strong> može istovremeno da traži isti poklon</span>
                            </li>
                            <li class="flex items-start">
                    ...
                    <!-- Steps -->
                    <h2 class="text-xl font-bold text-slate-900 dark:text-slate-100 mb-6">Koraci za dobijanje poklona</h2>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">Pronađite poklon</h3>
                                <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
                                    <p class="text-slate-600 dark:text-slate-400 mb-3">
                                        Idite na stranicu sa poklonima klikom na dugme "Pokloni" u glavnoj navigaciji ili <a href="{{ route('giveaways.index') }}" class="text-purple-600 dark:text-purple-400 hover:underline">kliknite ovde</a>.
                                    </p>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">Kliknite na "Želim poklon"</h3>
                                <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
                                    <p class="text-slate-600 dark:text-slate-400 mb-3">
                                        Kada pronađete poklon koji vas interesuje, kliknite na narančasto dugme "Želim poklon".
                                    </p>
                                    <div class="bg-orange-100 dark:bg-orange-900/30 border border-orange-300 dark:border-orange-700 rounded p-3 mb-3">
                                        <button class="w-full sm:w-auto px-4 py-2 bg-orange-600 text-white rounded-lg font-medium cursor-default">
                                            <i class="fas fa-hand-paper mr-2"></i> Želim poklon
                                        </button>
                                    </div>
                                    <p class="text-sm text-slate-500 dark:text-slate-400">
                                        Napomena: Dugme će prikazivati broj trenutnih zahteva (npr. 3/{{ \App\Models\Setting::get('max_giveaway_requests', 9) }}) ako već ima zainteresovanih.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">Napišite poruku</h3>
                                <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
                                    <p class="text-slate-600 dark:text-slate-400 mb-3">
                                        Otvoriće se prozor gde trebate napisati poruku vlasniku. Ova poruka je <strong>veoma važna</strong> jer na osnovu nje vlasnik bira kome će dati poklon.
                                    </p>
                                    <div class="bg-green-50 dark:bg-green-900/30 border border-green-300 dark:border-green-700 rounded p-3">
                    ...
                    <div class="mb-8">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">Sačekajte odluku</h3>
                                <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
                                    <p class="text-slate-600 dark:text-slate-400 mb-3">
                                        Nakon slanja zahteva, vlasnik će pregledati sve zahteve i doneti odluku. U međuvremenu:
                                    </p>
                                    <ul class="text-sm text-slate-600 dark:text-slate-400 space-y-2">
                    ...
                    <div class="mb-8">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">Dobijte obaveštenje</h3>
                                <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
                                    <p class="text-slate-600 dark:text-slate-400 mb-4">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div class="bg-red-50 dark:bg-red-900/30 border border-red-300 dark:border-red-700 rounded p-3">
                    ...
                    <div class="border border-slate-200 dark:border-slate-700 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-2">Za uspešno dobijanje:</h4>
                    ...
                    <div class="mt-8 bg-slate-50 dark:bg-slate-700/50 rounded-lg p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-3 bg-white dark:bg-slate-800 rounded">
                                ...
                                <button class="px-3 py-1.5 bg-orange-600 text-white rounded text-sm font-medium">
                                    <i class="fas fa-hand-paper mr-1"></i> Želim poklon (3/{{ \App\Models\Setting::get('max_giveaway_requests', 9) }})
                                </button>
                            </div>
                            <div class="flex items-center justify-between p-3 bg-white dark:bg-slate-800 rounded">
                                <span class="text-sm text-slate-600 dark:text-slate-400">Vaš zahtev je poslat:</span>
                                <button disabled class="px-3 py-1.5 bg-sky-600 text-white rounded text-sm font-medium opacity-50">
                            ...
                            <div class="flex items-center justify-between p-3 bg-white dark:bg-slate-800 rounded">
                                ...
                                <button disabled class="px-3 py-1.5 bg-amber-600 text-white rounded text-sm font-medium opacity-50">
                                    <i class="fas fa-users mr-1"></i> Max. broj zahteva
                                </button>
                            </div>
                            <div class="flex items-center justify-between p-3 bg-white dark:bg-slate-800 rounded">
                                <span class="text-sm text-slate-600 dark:text-slate-400">Poklon je dat:</span>
                                <button disabled class="px-3 py-1.5 bg-slate-600 text-white rounded text-sm font-medium opacity-50">
