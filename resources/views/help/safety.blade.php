    ...
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 py-8 px-2 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg overflow-hidden">
                <!-- Header -->
                <div class="bg-gradient-to-r from-emerald-500 to-teal-600 p-2 sm:p-8">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-emerald-100">Vaša sigurnost je naš prioritet. Saznajte kako da se zaštitite.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-2 sm:p-8">
                    <!-- Introduction -->
                    <div
                        class="mb-8 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-6">
                        ...
                        <p class="text-slate-600 dark:text-slate-400">
                            ...
                            Kontinuirano radimo na unapređenju bezbednosnih mera i edukaciji korisnika o sigurnoj
                            trgovini online.
                        </p>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-2">Kako prijaviti:
                                    </h4>
                                    <ul class="text-sm text-slate-600 dark:text-slate-400 space-y-1">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div
                                ...
                                <h3 class="font-semibold text-slate-800 dark:text-slate-200 mb-2">Verifikacija
                                    korisnika</h3>
                                <p class="text-sm text-slate-600 dark:text-slate-400">
                            ...
                            <div
                                class="bg-gradient-to-br from-blue-50 to-sky-50 dark:from-blue-900/20 dark:to-sky-900/20 rounded-lg p-4">
                            ...
                            <div
                                ...
                                <h3 class="font-semibold text-slate-800 dark:text-slate-200 mb-2">Sistem ocenjivanja
                                </h3>
                                <p class="text-sm text-slate-600 dark:text-slate-400">
                    ...
                    <div
                        class="bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-900/20 dark:to-gray-900/20 rounded-lg p-6 text-center">
                        <i class="fas fa-shield-alt text-4xl text-emerald-600 dark:text-emerald-400 mb-4"></i>
                        <h3 class="text-xl font-bold text-slate-900 dark:text-slate-100 mb-2">Bezbednosni tim je tu za
                            vas</h3>
