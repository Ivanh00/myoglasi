                ...
                <div class="p-2 sm:p-8">
                    ...
                    <div
                        ...
                        <p class="text-slate-600 dark:text-slate-400">
                            PazAriO nagrađuje aktivne korisnike besplatnim kreditima. Što ste aktivniji na platformi,
                            više kredita možete zaraditi za promociju vaših oglasa.
                        </p>
                    </div>

                    <!-- Ways to Earn -->
                    <h2 class="text-xl font-bold text-slate-900 dark:text-slate-100 mb-6">Načini zarađivanja kredita
                    </h2>
                    ...
                    <div class="mb-6 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                        <div class="bg-gradient-to-r from-green-500 to-emerald-500 p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-white font-bold">+10
                                    kredita</span>
                            </div>
                        </div>
                        <div class="p-4">
                        ...
                        <div class="p-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <span class="text-slate-600 dark:text-slate-400">Kliknite "Pošalji verifikacioni
                                        email"</span>
                                </div>
                                <div class="flex items-start">
                                    <span class="text-sky-500 mr-2">3.</span>
                                    <span class="text-slate-600 dark:text-slate-400">Otvorite email i kliknite na
                                        link</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-6 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                        <div class="bg-gradient-to-r from-purple-500 to-pink-500 p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-white font-bold">+1
                                    kredit/dan</span>
                            </div>
                        </div>
                        <div class="p-4">
                            ...
                            <div class="grid grid-cols-7 gap-2 mb-3">
                                @for ($i = 1; $i <= 7; $i++)
                                    <div
                                        class="aspect-square bg-{{ $i <= 5 ? 'green' : 'slate' }}-100 dark:bg-{{ $i <= 5 ? 'green' : 'slate' }}-900/30 rounded-lg flex items-center justify-center">
                                        <span
                                            class="text-{{ $i <= 5 ? 'green' : 'slate' }}-600 dark:text-{{ $i <= 5 ? 'green' : 'slate' }}-400 text-sm font-bold">{{ $i }}</span>
                                    </div>
                                @endfor
                            </div>
                    ...
                    <div class="mb-6 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                        <div class="bg-gradient-to-r from-red-500 to-rose-500 p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-white font-bold">+5
                                    kredita</span>
                            </div>
                        </div>
                        <div class="p-4">
                            ...
                            <div class="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4 mb-3">
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Vaš
                                    referral link:</label>
                                <div class="flex">
                            ...
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-slate-600 dark:text-slate-400">Pozvali ste: <strong>3
                                        prijatelja</strong></span>
                                <span class="text-green-600 dark:text-green-400">Zaradili: <strong>15
                                        kredita</strong></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <div class="space-y-2">
                                <div
                                    class="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-900/50 rounded">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div
                                class="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-lg p-4">
                            ...
                            <div
                                class="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg p-4">
                                <div class="flex items-center mb-2">
                                ...
                                <p class="text-sm text-slate-600 dark:text-slate-400 mb-2">Završite prvu transakciju
                                </p>
                                <p class="text-green-600 dark:text-green-400 font-bold">+5 kredita</p>
                            </div>
                            <div
                                class="bg-gradient-to-br from-sky-50 to-blue-50 dark:from-sky-900/20 dark:to-blue-900/20 rounded-lg p-4">
                                <div class="flex items-center mb-2">
                            ...
                            <div
                                class="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg p-4">
                                <div class="flex items-center mb-2">
                            ...
                            <table class="w-full">
                                <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                                    <tr>
                                        ...
                                        <td class="py-2 text-right font-bold text-green-600 dark:text-green-400">40+
                                            kredita</td>
                                    </tr>
                                    <tr>
                                        <td class="py-2 text-slate-600 dark:text-slate-400">Dnevno (mesečno)</td>
                                        <td class="py-2 text-right font-bold text-green-600 dark:text-green-400">30+
                                            kredita</td>
                                    </tr>
                                    <tr>
                                        <td class="py-2 text-slate-600 dark:text-slate-400">Preporuke (po prijatelju)
                                        </td>
                                        <td class="py-2 text-right font-bold text-green-600 dark:text-green-400">5
                                            kredita</td>
                                    </tr>
                                </tbody>
                            </table>
