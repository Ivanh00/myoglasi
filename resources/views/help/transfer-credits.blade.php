    ...
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 py-8 px-2 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg overflow-hidden">
                <!-- Header -->
                <div class="bg-gradient-to-r from-blue-500 to-cyan-600 p-2 sm:p-8">
                ...
                <div class="p-2 sm:p-8">
                    ...
                    <div
                        ...
                        <p class="text-slate-600 dark:text-slate-400 mb-4">
                            Transfer kredita vam omogućava da podelite vaše kredite sa drugim korisnicima PazAriO
                            platforme. Ovo je korisno kada želite da pomognete prijateljima ili članovima porodice da
                            promovišu svoje oglase.
                        </p>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Vaš nalog mora biti
                                        verifikovan (email ili telefon)</p>
                                </div>
                            </div>
                            <div class="flex items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                <i class="fas fa-check-circle text-green-500 text-xl mr-3"></i>
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Možete poslati minimum 10
                                        kredita u jednoj transakciji</p>
                                </div>
                            </div>
                            <div class="flex items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                <i class="fas fa-check-circle text-green-500 text-xl mr-3"></i>
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Korisnik kome šaljete mora
                                        postojati na platformi</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            <div
                                class="flex-shrink-0 w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mr-4">
                                <span class="text-blue-600 dark:text-blue-400 font-bold">1</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Idite na vaš
                                    profil</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                    Kliknite na vašu profilnu sliku ili ime u gornjem desnom uglu, zatim izaberite "Moj
                                    profil".
                                </p>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Pronađite
                                    sekciju "Krediti"</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <span class="text-2xl font-bold text-green-600 dark:text-green-400">125
                                            kredita</span>
                                    </div>
                                    <button
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Unesite
                                    podatke za transfer</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                    Popunite formu sa podacima o transferu.
                                </p>
                                <div
                                    class="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg p-4 space-y-4">
                                    <div>
                                        <label
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Potvrdite
                                    transfer</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                ...
                                <div
                                    ...
                                    <div class="space-y-2 text-sm">
                                        <div class="flex justify-between">
                                            ...
                                            <span
                                                class="font-medium text-slate-700 dark:text-slate-300">marko123</span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-slate-600 dark:text-slate-400">Količina:</span>
                                            <span class="font-medium text-slate-700 dark:text-slate-300">25
                                                kredita</span>
                                        </div>
                                        <div
                                            class="border-t border-amber-300 dark:border-amber-700 pt-2 flex justify-between">
                                            <span class="text-slate-600 dark:text-slate-400">Novo stanje:</span>
                                            <span class="font-bold text-slate-700 dark:text-slate-300">100
                                                kredita</span>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <p class="text-sm text-red-800 dark:text-red-300">
                                        ...
                                        <strong>Važno:</strong> Transfer kredita je nepovratan! Proverite da li ste
                                        uneli tačno korisničko ime.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Primite
                                    potvrdu</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center mb-3">
                                        ...
                                        <h4 class="font-medium text-green-800 dark:text-green-300">Transfer uspešan!
                                        </h4>
                                    </div>
                        ...
                        <div class="space-y-4">
                            <details class="group">
                                <summary
                                    ...
                                    <span class="font-medium text-slate-700 dark:text-slate-300">Mogu li poništiti
                                        transfer?</span>
                                    <i
                            ...
                            <details class="group">
                                <summary
                                    class="flex justify-between items-center cursor-pointer p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-900/70">
                                    <span class="font-medium text-slate-700 dark:text-slate-300">Šta ako pošaljem na
                                        pogrešan nalog?</span>
                                    <i
                                        class="fas fa-chevron-down group-open:rotate-180 transition-transform text-slate-500"></i>
                                </summary>
                                <p class="p-4 text-slate-600 dark:text-slate-400">
                                    Kontaktirajte podršku odmah. Ako primalac nije iskoristio kredite, možda možemo
                                    pomoći.
                                </p>
                            </details>
                            ...
                            <details class="group">
                                <summary
                                    class="flex justify-between items-center cursor-pointer p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-900/70">
                                    <span class="font-medium text-slate-700 dark:text-slate-300">Da li ima provizije za
                                        transfer?</span>
                                    <i
                                        class="fas fa-chevron-down group-open:rotate-180 transition-transform text-slate-500"></i>
                                </summary>
                                <p class="p-4 text-slate-600 dark:text-slate-400">
                                    Ne, transfer kredita je potpuno besplatan. Primalac dobija tačan iznos koji
                                    pošaljete.
                                </p>
                            </details>
                        </div>
