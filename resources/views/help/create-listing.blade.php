    ...
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 py-8 px-2 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg overflow-hidden">
                <!-- Header -->
                <div class="bg-gradient-to-r from-sky-500 to-sky-600 p-2 sm:p-8">
                ...
                <div class="p-2 sm:p-8">
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            <div
                                class="flex-shrink-0 w-10 h-10 bg-sky-100 dark:bg-sky-900/30 rounded-full flex items-center justify-center mr-4">
                                <span class="text-sky-600 dark:text-sky-400 font-bold">1</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Prijavite se
                                    na svoj nalog</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                    Pre postavljanja oglasa, potrebno je da budete prijavljeni na svoj nalog. Ako nemate
                                    nalog, možete ga besplatno kreirati.
                                </p>
                                <div
                                    class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                                    <p class="text-sm text-amber-800 dark:text-amber-300">
                                        <i class="fas fa-lightbulb mr-2"></i>
                                        <strong>Savet:</strong> Verifikovani nalozi imaju veću vidljivost i poverenje
                                        kupaca.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Kliknite na
                                    "Dodaj oglas"</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                    U glavnom meniju ili na početnoj stranici, pronađite dugme "Dodaj oglas" i kliknite
                                    na njega.
                                </p>
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Izaberite
                                    kategoriju</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                    Odaberite odgovarajuću kategoriju i potkategoriju za vaš proizvod. Ovo pomaže
                                    kupcima da lakše pronađu vaš oglas.
                                </p>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4 space-y-3">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-3 text-slate-700 dark:text-slate-300"><strong>Naslov:</strong>
                                            Kratak i jasan naziv proizvoda</span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-align-left text-sky-500 w-6"></i>
                                        <span class="ml-3 text-slate-700 dark:text-slate-300"><strong>Opis:</strong>
                                            Detaljan opis sa svim karakteristikama</span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-euro-sign text-sky-500 w-6"></i>
                                        <span class="ml-3 text-slate-700 dark:text-slate-300"><strong>Cena:</strong>
                                            Postavite realnu cenu ili "Po dogovoru"</span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-map-marker-alt text-sky-500 w-6"></i>
                                        <span class="ml-3 text-slate-700 dark:text-slate-300"><strong>Lokacija:</strong>
                                            Grad i opština</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Pregledajte i
                                    objavite</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                    Pre objave, pregledajte sve unete informacije. Možete odabrati i dodatne opcije
                                    promocije:
                                </p>
                                <div class="space-y-3">
                                    <div class="border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                                        ...
                                        <p class="text-sm text-slate-600 dark:text-slate-400">Vaš oglas će biti
                                            istaknut na početnoj stranici</p>
                                    </div>
                                    <div class="border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                                        <div class="flex items-center justify-between mb-2">
                                            <span class="font-medium text-slate-700 dark:text-slate-300">
                                        ...
                                        <p class="text-sm text-slate-600 dark:text-slate-400">Oglas će biti među prvima
                                            u rezultatima pretrage</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- CTA Section -->
                    <div
                        class="mt-12 bg-gradient-to-r from-sky-50 to-blue-50 dark:from-sky-900/20 dark:to-blue-900/20 rounded-lg p-6">
                        <div class="text-center">
                            <h3 class="text-xl font-bold text-slate-900 dark:text-slate-100 mb-3">Spremni ste za
                                postavljanje oglasa?</h3>
                    ...
                    <div class="mt-12 border-t border-slate-200 dark:border-slate-700 pt-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <a href="{{ route('help.create-auction') }}"
                                ...
                                <h4
                                    class="font-medium text-slate-900 dark:text-slate-100 group-hover:text-sky-600 dark:group-hover:text-sky-400 mb-1">
                                    <i class="fas fa-gavel mr-2"></i>Kako postaviti aukciju
                                </h4>
                                <p class="text-sm text-slate-600 dark:text-slate-400">Saznajte kako da prodate proizvod
                                    putem aukcije</p>
                            </a>
                            <a href="{{ route('help.promotions') }}"
                                ...
                                <p class="text-sm text-slate-600 dark:text-slate-400">Kako da povećate vidljivost vašeg
                                    oglasa</p>
                            </a>
                        </div>
                    </div>
