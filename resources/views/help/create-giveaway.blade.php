        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-green-500 to-emerald-600 p-2 sm:p-8">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-green-100">Podelite stvari koje vam više nisu potrebne sa onima kojima mogu
                                koristiti</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-2 sm:p-8">
                    <!-- What is Giveaway -->
                    <div
                        class="mb-8 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 mb-4">
                            Poklon je način da besplatno podelite stvari koje vam više nisu potrebne sa drugim
                            korisnicima. Ovo je odličan način da pomognete nekome, smanjite otpad i oslobodite prostor u
                            vašem domu.
                        </p>
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div class="text-center">
                                <i
                                    class="fas fa-hand-holding-heart text-3xl text-green-600 dark:text-green-400 mb-2"></i>
                    ...
                    <div class="mb-8 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <h4
                                    class="font-medium text-slate-700 dark:text-slate-300 mb-2 text-green-600 dark:text-green-400">
                            ...
                            <div>
                                <h4
                                    class="font-medium text-slate-700 dark:text-slate-300 mb-2 text-red-600 dark:text-red-400">
                    ...
                    <!-- Steps -->
                    <h2 class="text-xl font-bold text-slate-900 dark:text-slate-100 mb-6">Koraci za postavljanje poklona
                    </h2>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            <div
                                class="flex-shrink-0 w-10 h-10 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center mr-4">
                                <span class="text-green-600 dark:text-green-400 font-bold">1</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Idite na
                                    opciju "Postavi poklon"</h3>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Unesite naziv
                                    poklona</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                    Napišite kratak i jasan naziv koji opisuje šta poklanjate.
                                </p>
                                <div
                                    class="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                                    <label
                                        class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Naziv
                                        poklona</label>
                                    <input type="text"
                                        placeholder="npr. Dečije knjige, Ženski zimski kaput, Set posuđa..."
                                    ...
                                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                                        💡 Savet: Budite specifični - umesto "Odeća" napišite "Ženska letnja odeća
                                        veličine M"
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="space-y-3">
                                    <div
                                        class="bg-sky-50 dark:bg-sky-900/20 border border-sky-200 dark:border-sky-800 rounded-lg p-4">
                                        <p class="text-sm text-sky-800 dark:text-sky-300">
                                            <i class="fas fa-info-circle mr-2"></i>
                                            <strong>Napomena:</strong> Koriste se iste kategorije kao za oglase, što
                                            olakšava pronalaženje poklona.
                                        </p>
                                    </div>
                                    <div class="grid grid-cols-2 gap-3">
                                        <button
                                            class="p-3 text-left border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Dodajte opis
                                    (opciono)</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                ...
                                <div
                                    class="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                                    <label
                                        class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Opis
                                        poklona</label>
                                    <textarea rows="4"
                                        placeholder="npr. Poklanjam set knjiga za decu, očuvane, iz nepušačkog doma. Preuzimanje na Novom Beogradu..."
                                        class="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100"
                                        disabled></textarea>
                                    <div class="mt-3 space-y-2">
                                        <p class="text-xs text-slate-600 dark:text-slate-400">
                                            <i class="fas fa-check text-green-500 mr-1"></i> Navedite stanje (novo,
                                            korišćeno, očuvano)
                                        </p>
                                        <p class="text-xs text-slate-600 dark:text-slate-400">
                                            <i class="fas fa-check text-green-500 mr-1"></i> Lokacija i način
                                            preuzimanja
                                        </p>
                                        <p class="text-xs text-slate-600 dark:text-slate-400">
                                            <i class="fas fa-check text-green-500 mr-1"></i> Eventualni uslovi (npr. za
                                            porodice sa decom)
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Dodajte
                                    fotografije</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                    Dodajte jasne fotografije predmeta koje poklanjate. Fotografije povećavaju šanse da
                                    neko preuzme poklon.
                                </p>
                                <div
                                    class="border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-lg p-8 text-center">
                                    <i class="fas fa-cloud-upload-alt text-4xl text-slate-400 mb-3"></i>
                                    <p class="text-slate-600 dark:text-slate-400 mb-2">Prevucite fotografije ovde ili
                                        kliknite za izbor</p>
                                    <button
                                        class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
                                        <i class="fas fa-camera mr-2"></i>Izaberite fotografije
                                    </button>
                                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-3">Maksimalno 10
                                        fotografija • JPG, PNG do 5MB</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Objavite
                                    poklon</h3>
                                <p class="text-slate-600 dark:text-slate-400 mb-3">
                                ...
                                <div
                                    ...
                                    <ul class="text-sm text-green-700 dark:text-green-400 space-y-1">
                                        <li>• Poklon se pojavljuje u kategoriji "Poklanjam" i u odabranoj kategoriji
                                        </li>
                    ...
                    <!-- Benefits Section -->
                    <div
                        class="mt-12 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Verifikovani korisnici i
                                        sistem ocenjivanja</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Hiljade korisnika vidi vaš
                                        poklon</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Dobijate pozitivne ocene za
                                        poklone</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h4 class="font-medium text-slate-700 dark:text-slate-300">Ekološki</h4>
                                    <p class="text-sm text-slate-600 dark:text-slate-400">Smanjujete otpad i čuvate
                                        prirodu</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start">
                                ...
                                <p class="text-slate-600 dark:text-slate-400">
                                    <strong class="text-slate-700 dark:text-slate-300">Budite iskreni:</strong> Opišite
                                    tačno stanje predmeta
                                </p>
                            </div>
                            <div class="flex items-start">
                                <span class="text-green-500 mr-2">✓</span>
                                <p class="text-slate-600 dark:text-slate-400">
                                    <strong class="text-slate-700 dark:text-slate-300">Brzo odgovarajte:</strong> Na
                                    poruke zainteresovanih
                                </p>
                            </div>
                            <div class="flex items-start">
                                <span class="text-green-500 mr-2">✓</span>
                                <p class="text-slate-600 dark:text-slate-400">
                                    <strong class="text-slate-700 dark:text-slate-300">Organizujte
                                        preuzimanje:</strong> Dogovorite tačno vreme i mesto
                                </p>
                            </div>
                            <div class="flex items-start">
                                <span class="text-green-500 mr-2">✓</span>
                                <p class="text-slate-600 dark:text-slate-400">
                                    <strong class="text-slate-700 dark:text-slate-300">Označite kao
                                        poklonjeno:</strong> Kada predate poklon
                                </p>
                            </div>
                        </div>
                    </div>
