...
<head>
    ...
    <style>
        ...
        .dark .bg-sky-50 {
            background-color: rgb(30 58 138) !important;
            /* sky-900 - dark blue for unread */
        }

        .dark .text-sky-700 {
            color: rgb(147 197 253) !important;
            /* sky-300 - light blue text */
        }

        .dark .text-sky-600 {
            color: rgb(147 197 253) !important;
            /* sky-300 - consistent blue links */
        }
        ...
        .dark tbody tr.bg-sky-50 {
            background-color: rgb(30 58 138) !important;
            /* sky-900 - same as unread messages */
        }

        .dark tbody tr.bg-red-50 {
            background-color: rgb(127 29 29) !important;
            /* red-900 - for suspicious visitors */
        }

        /* Green elements in earning credit section */
        .dark .text-green-800 {
            color: rgb(134 239 172) !important;
            /* green-300 - readable green */
        }

        .dark .bg-green-100 {
            background-color: rgb(20 83 45) !important;
            /* green-900 - dark green background */
        }

        .dark .bg-green-50 {
            background-color: rgb(20 83 45) !important;
            /* green-900 - dark green background for sections */
        }

        .dark .border-green-200 {
            border-color: rgb(34 197 94) !important;
            /* green-500 - visible green border */
        }
        ...
        .dark .hover\\:text-indigo-300:hover {
            color: rgb(199 210 254) !important;
            /* indigo-200 - even lighter on hover */
        }
        ...
        .dark .hover\\:text-green-300:hover {
            color: rgb(187 247 208) !important;
            /* green-200 - even lighter on hover */
        }
        ...
        .dark .hover\\:text-orange-300:hover {
            color: rgb(254 215 170) !important;
            /* orange-200 - even lighter on hover */
        }
        ...
        .dark .hover\\:text-amber-300:hover {
            color: rgb(254 240 138) !important;
            /* amber-200 - even lighter on hover */
        }
        ...
        .dark button.text-red-600 {
            background-color: rgb(127 29 29) !important;
            /* red-900 - dark red background */
            color: rgb(252 165 165) !important;
            /* red-300 - light red text */
            border-color: rgb(220 38 38) !important;
            /* red-600 - visible red border */
        }
...
<body class="font-sans antialiased bg-slate-100 dark:bg-slate-900">
    <div class="min-h-screen">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <button type="button" id="mobile-admin-sidebar-button"
                            ...
                            <svg id="admin-menu-icon" class="h-6 w-6" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4 6h16M4 12h16M4 18h16" />
                            </svg>
                            <svg id="admin-close-icon" class="h-6 w-6 hidden" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                class="flex items-center text-sm font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500">
                                @if (auth()->user()->avatar)
        ...
        <div id="mobile-admin-user-menu"
            class="md:hidden hidden absolute top-16 right-4 w-48 bg-white rounded-md shadow-lg py-1 z-20 border border-slate-200">
            <div class="px-4 py-2 text-sm text-slate-500 dark:text-slate-300 border-b border-slate-200">
                {{ auth()->user()->name }}
            </div>
        ...
        <div id="mobile-admin-sidebar-overlay" class="fixed inset-0 bg-slate-500 bg-opacity-75 z-30 md:hidden hidden">
        </div>
        ...
        <div class="flex">
            ...
            <aside class="hidden md:block w-64 bg-white dark:bg-slate-800 shadow-sm min-h-screen">
                <div class="p-6">
                    <!-- Theme Switcher -->
                    <div
                        class="mb-6 p-3 bg-slate-50 dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600">
                        <div
                            class="text-xs font-semibold text-slate-500 dark:text-slate-300 uppercase tracking-wider mb-2">
                            Tema</div>
                    ...
                    <nav class="space-y-2">
                        <a href="{{ route('admin.dashboard') }}"
                            ...
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 5a2 2 0 012-2h4a2 2 0 012 2v6a2 2 0 01-2 2H10a2 2 0 01-2-2V5zM8 5a2 2 0 012-2h4a2 2 0 012 2v6a2 2 0 01-2 2H10a2 2 0 01-2-2V5z">
                                </path>
                            </svg>
                            Dashboard
                        </a>
            ...
            <!-- Mobile Sidebar -->
            <aside id="mobile-admin-sidebar"
                class="fixed left-0 top-16 w-64 bg-white dark:bg-slate-800 shadow-lg min-h-screen z-40 transform -translate-x-full transition-transform duration-300 ease-in-out md:hidden">
                <div class="p-6">
                    <!-- Theme Switcher -->
                    <div
                        class="mb-6 p-3 bg-slate-50 dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600">
